...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Malitos Premium Check — Diario CrossFit" },
      { name: "description", content: "Tu diario definitivo de entrenamiento CrossFit: planificación, PR, estadísticas y progreso." },
      { property: "og:title", content: "Malitos Premium Check" },
      { property: "og:description", content: "Diario premium de entrenamiento CrossFit." },
